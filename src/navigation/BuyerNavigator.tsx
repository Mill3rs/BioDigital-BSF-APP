  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{ title: 'Cart', tabBarLabel: 'Cart', tabBarIcon: ({ focused }) => <TabIcon emoji="🛒" label="Cart" focused={focused} /> }}
      />
      <Tab.Screen
        name="OrdersTab"
      ...
      <Tab.Screen
        ...
        options={{ title: 'Notifications', tabBarLabel: 'Alerts', tabBarIcon: ({ focused }) => <TabIcon emoji="🔔" label="Alerts" focused={focused} /> }}
      />
      <Tab.Screen
        name="ProfileTab"
